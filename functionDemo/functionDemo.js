...
// (the plus signs around 'sum' are concatinating the sum, or else just the word "sum" would should up)
...
// use a loop to access the items in the array and add to the output string (i++ means you are incrementing by 1)
...
var count = 5 + Math.floor(Math.random() * 11); // Math.random() generates a decimal between 0 
                                            // and 1
                                // multiplying times 11 generates a decimal between 5 and 15 or 16 numbers
